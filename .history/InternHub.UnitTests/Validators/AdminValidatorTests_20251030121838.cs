...
public class AdminServiceTests
{
    ...
    private readonly Mock<ICompanyRepository> companyMock;
    private readonly Mock<IJobRepository> jobMock;
    private readonly Mock<UserManager<ApplicationUser>> userMock;
    private readonly AdminServiceTests adminService;
}