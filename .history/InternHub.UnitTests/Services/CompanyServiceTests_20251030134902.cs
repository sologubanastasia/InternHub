...
namespace InternHub.UnitTests.Services
{
    public class CompanyServiceTests
    {
        ...
        public async Task GetCompanyJobsAsync_ShouldReturnJobs()
        {
            ...
            {
                new JobEntity { Id = Guid.NewGuid(), Title = "Job1", CompanyId = company.Id, Applications = new List<JobApplication>() },
                new JobEntity { Id = Guid.NewGuid(), Title = "Job2", CompanyId = company.Id, Applications = new List<JobApplication> { new JobApplication() } }
            };
        ...
        public async Task CreateJobAsync_ShouldAddJob()
        {
            ...
            _jobRepoMock.Verify(r => r.AddAsync(It.Is<JobEntity>(j =>
                j.Title == dto.Title &&
        ...
        public async Task GetJobApplicationsAsync_ShouldReturnApplications()
        {
            ...
            var job = new JobEntity
            {
                ...
                {
                    new JobApplication { Id = Guid.NewGuid(), AppliedDate = DateTime.UtcNow, Status = ApplicationStatus.Pending }
                }
            };
        ...
        {
            _jobRepoMock.Setup(r => r.GetByIdAsync(It.IsAny<Guid>())).ReturnsAsync((JobEntity?)null);
