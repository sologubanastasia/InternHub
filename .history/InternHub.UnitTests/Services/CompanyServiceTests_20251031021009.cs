...
namespace InternHub.UnitTests.Services
{
    public class CompanyServiceTests
    {
        ...
        public async Task GetCompanyJobsAsync_ShouldReturnJobs()
        {
            ...
            {
                new Job { Id = Guid.NewGuid(), Title = "Job1", CompanyId = company.Id, Applications = new List<ApplicationEntity>() },
                new Job { Id = Guid.NewGuid(), Title = "Job2", CompanyId = company.Id, Applications = new List<ApplicationEntity> { new ApplicationEntity() } }
            };
