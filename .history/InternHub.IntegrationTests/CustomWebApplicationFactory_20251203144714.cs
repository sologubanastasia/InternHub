    ...
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                // Очищення та створення бази даних для гарантії чистого стану
        ...
        private static async Task SeedTestDataAsync(UserManager<ApplicationUser> userManager, InternHubDbContext db)
        {
            ...
            // --- Посів Проектів (ВИПРАВЛЕНО Title на Name) ---
            ...
            db.Projects.Add(new Project
            {
                ...
                Name = "Details Project", // ВИПРАВЛЕНО
            ...
            db.Projects.Add(new Project
            {
                ...
                CandidateId = ownerCandidateId,
                Name = "Update Project", // ВИПРАВЛЕНО
            ...
            db.Projects.Add(new Project
            {
                ...
                CandidateId = ownerCandidateId,
                Name = "Removal Project", // ВИПРАВЛЕНО
