...
using System.Linq;
using System;
using Microsoft.EntityFrameworkCore; // Потрібно для FirstOrDefaultAsync, якщо ви його використовуєте в репозиторії
    ...
    public class ProjectControllerTests : IClassFixture<CustomWebApplicationFactory>
    {
        ...
        private void EnsureTestProjectId()
        {
            if (_testProjectId == Guid.Empty)
            {
                ...
                // Виправлено: Прибрано OrderByDescending(p => p.CreatedAt) через CS1061
                ...
                {
                    // Це означає, що Test01 не спрацював.
