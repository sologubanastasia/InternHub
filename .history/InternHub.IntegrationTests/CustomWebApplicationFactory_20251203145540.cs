    ...
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                // 2. Створення бази даних та застосування міграцій
                // Це виправляє проблему RoleNameIndex (23505)
                db.Database.Migrate();

                // Посів ролей та даних (синхронно, як і раніше)
        ...
        private static async Task SeedTestDataAsync(UserManager<ApplicationUser> userManager, InternHubDbContext db)
        {
            ...
            // --- Посів Технологій ---
            // Додайте перевірку, щоб уникнути повторного додавання, якщо тест не повністю очистив таблицю
