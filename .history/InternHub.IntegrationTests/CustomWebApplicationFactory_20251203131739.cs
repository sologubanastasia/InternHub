...
namespace InternHub.IntegrationTests
{
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        private static async Task SeedTestDataAsync(UserManager<ApplicationUser> userManager, InternHubDbContext db)
        {
            ...
            // 1. Власник проекту (використовується як OwnerCandidate)
            ...
            // 2. Член проекту (MemberCandidate)
            ...
            // 3. Кандидат, що не є членом проекту (NonMemberCandidate)
            ...
            // 2. ProjectIdForUpdate (для PUT {id} та GetProjects/my)
            db.Projects.Add(new Project
            {
            ...
            // 3. ProjectIdForMemberRemoval (для DELETE {id}/members/{memberId} та GetProjects/my)
            db.Projects.Add(new Project
            {
