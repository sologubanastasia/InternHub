...
namespace InternHub.IntegrationTests
{
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        private static async Task SeedTestDataAsync(UserManager<ApplicationUser> userManager, InternHubDbContext db)
        {
            ...
            // *** НОВИЙ ID ПРОЕКТУ ***
            var testProjectId = Guid.Parse("019ae3c5-909e-70bb-a16f-c18ff0b10a58"); 
            ...
            // Project Owner Candidate (555...5555) - для ProjectControllerTests
            ...
            // Project Member Candidate (666...6666) - для ProjectControllerTests
            ...
            // --- 3. Створення інших сутностей (Jobs, Projects) ---
            ...
            // *** ДОДАВАННЯ ТЕСТОВОГО ПРОЕКТУ ***
            // Цей запис потрібен, щоб ProjectControllerTests не отримували 500 (NullReferenceException)
            // при спробі отримати деталі проекту.
            if (!db.Projects.Any(p => p.Id == testProjectId))
            {
                db.Projects.Add(new Project
                {
                    Id = testProjectId,
                    Title = "Existing Test Project",
                    Description = "This is a seeded project for ProjectController integration tests.",
                    OwnerId = projectOwnerId, // Належить користувачу 555...5555
