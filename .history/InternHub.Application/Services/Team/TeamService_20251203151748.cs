...
namespace InternHub.Application.Services.Team
{
    ...
    public class TeamService : ITeamService
    {
        ...
        public async Task RemoveMemberAsync(Guid projectId, Guid ownerUserId, Guid memberUserId)
        {
            ...
            // 2. Отримання CandidateId за UserId (використовуючи наданий репозиторій)
            ...
            // Припускаємо, що у ProjectMemberRepository є метод GetProjectMemberAsync(Guid projectId, Guid candidateId)
