...
InternHub.Application.DTO.Auth
...
namespace InternHub.Application.Services.Company
{
    public class CompanyService : ICompanyService
    {
        ...
        public async Task RegisterAsync(RegisterCompanyDto dto)
        {
            ...
            user.Company = new Company { Status = CompanyStatus.WaitingForAdminApproval };
        ...
        public async Task<bool> LoginAsync(string email, string password)
        {
            ...
            if (user?.Company?.Status != CompanyStatus.Approved) return false;
