...
// 👇 псевдоніми, щоб уникнути конфліктів назв
using DomainApplication = InternHub.Domain.Application;
using DomainJob = InternHub.Domain.Job;
using DomainCompany = InternHub.Domain.Company;
    ...
    public class CompanyService : ICompanyService
    {
        ...
        public async Task<IEnumerable<JobApplicationResponseDto>> GetJobApplicationsAsync(Guid jobId)
        {
            ...
            return job.Applications.Select(a => new JobApplicationResponseDto
            {
                ...
                AppliedDate = a.AppliedDate, // ✅ виправлено
