...
namespace InternHub.Infrastructure.Repositories
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<ApplicationUser?> GetApplicationUserByIdAsync(Guid ApplicationUserId)
        {
            return await _context.ApplicationUsers
                .Include(u => u.Candidate)
                .Include(u => u.Company)
        ...
        public async Task RegisterApplicationUserAsync(ApplicationUser ApplicationUser)
        {
